...
const SmartSecureSection = () => {
    ...
    const {
        ...
        inView: firstCenteredListItemInView
    } = useInView({
        threshold: 0
    });
    ...
    const {
        ...
        inView: thirdCenteredListItemInView
    } = useInView({
        threshold: 0
    });
    ...
    return (
        <div className={styles.smartSecureSection}>
            ...
            <CenteredListItem
                className={`${
                    firstCenteredListItemInView ? styles.animate : ''
                } ${styles.firstCenteredListItem} ${styles.centeredListItem}`}
                icon={<CloudIcon />}
                ref={firstCenteredListItemRef}
            ...
            <CenteredListItem
                className={`${
                    secondCenteredListItemInView ? styles.animate : ''
                } ${styles.secondCenteredListItem} ${styles.centeredListItem}`}
                icon={<LockIcon />}
                ref={secondCenteredListItemRef}
            ...
            <CenteredListItem
                className={`${
                    thirdCenteredListItemInView ? styles.animate : ''
                } ${styles.thirdCenteredListItem} ${styles.centeredListItem}`}
                icon={<NotepadIcon />}
                ref={thirdCenteredListItemRef}
