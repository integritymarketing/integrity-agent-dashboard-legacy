...
const CenteredSection = forwardRef(({ className = '', text, title }, ref) => {
    ...
    return (
        <section className={`${className} ${styles.centeredSection}`} ref={ref}>
            <ContentContainer>
                <div className={styles.container}>
                    <SectionTitle
                        className={`${
                            sectionTitleInView ? styles.animate : ''
                        } ${styles.sectionTitle}`}
                        ref={sectionTitleRef}
                        text={title}
                    />
                    ...
                    <Text
                        className={`${textInView ? styles.animate : ''} ${
                            styles.text
                        }`}
                        ref={textRef}
                        text={text}
