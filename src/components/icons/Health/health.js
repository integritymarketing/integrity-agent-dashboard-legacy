export const Health = () => (
    <svg id="Policy_Status_Circle_Health" data-name="Policy Status Circle – Health" xmlns="http://www.w3.org/2000/svg" width="52" height="40" viewBox="0 0 52 40">
        <g id="IconCircleBG">
            <circle id="Ellipse_299" data-name="Ellipse 299" cx="20" cy="20" r="20" fill="#f1faff" />
        </g>
        <g id="Health_Policy_Unlinked" data-name="Health Policy Unlinked" transform="translate(8 8)">
