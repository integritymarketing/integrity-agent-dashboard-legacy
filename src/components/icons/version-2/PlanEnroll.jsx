const PlanEnroll = () => {
    return (
        <svg id="PlanEnroll" xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24">
            <g id="Button_-_BG" data-name="Button - BG">
                <rect id="bg" width="24" height="24" fill="#ff1717" opacity="0" />
            </g>
            <g id="Group_5425" data-name="Group 5425" transform="translate(3.4 3.604)">
                <path
                    id="Path_20977"
