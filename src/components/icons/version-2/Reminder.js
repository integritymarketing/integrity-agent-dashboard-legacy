export const Reminder = () => (
    <svg id="Reminder_Status" data-name="Reminder Status" xmlns="http://www.w3.org/2000/svg" width="52" height="40" viewBox="0 0 52 40">
        <g id="Group_9227" data-name="Group 9227">
            ...
            <g id="IconCircleBG-2" data-name="IconCircleBG" transform="translate(8 8)">
                <g id="Ellipse_299-2" data-name="Ellipse 299" fill="#fff" stroke="#4178ff" stroke-width="1">
            ...
            <g id="StatusCount" transform="translate(36 12)" opacity="0">
                ...
                <text id="_3" data-name="3" transform="translate(4 13)" fill="#4178ff" font-size="13" font-family="Lato-Regular, Lato"><tspan x="0" y="0">3</tspan></text>
            </g>
        </g>
    </svg>
)