const AddReminder = ({}) => (
    ...
    >
        ...
        <g id="IconCircleBG-2" data-name="IconCircleBG" transform="translate(8 8)">
            <g id="Ellipse_299-2" data-name="Ellipse 299" fill="#fff" stroke="#717171" stroke-width="1">
        ...
        <g id="Reminder_Updated" data-name="Reminder Updated" transform="translate(8 8)">
            ...
            <g id="icon" transform="translate(5 4)">
                <path
                    ...
                    fill="#717171"
                />
                <g id="icon-2" data-name="icon" transform="translate(-1.577 -0.577)">
                    <line
                        id="Line_653"
                        data-name="Line 653"
                        y2="4"
                        transform="translate(8.577 6.577)"
                        fill="none"
                        stroke="#717171"
                    ...
                    <line
                        ...
                        data-name="Line 654"
                        x2="4"
                        transform="translate(6.577 8.577)"
                        fill="none"
                        stroke="#717171"
                        stroke-linecap="round"
                        stroke-width="1"
