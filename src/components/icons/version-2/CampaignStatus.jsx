const CampaignStatus = ({ status }) => {
    return (
        <svg id="Campaigns_-_Status" data-name="Campaigns - Status" xmlns="http://www.w3.org/2000/svg" width="40" height="40" viewBox="0 0 40 40">
            <g id="IconCircleBG">
                <circle id="Ellipse_299" data-name="Ellipse 299" cx="20" cy="20" r="20" fill="#f1faff" />
            </g>
            <g id="Source_-_PlanEnroll" data-name="Source - PlanEnroll" transform="translate(8 8)">
                <g id="Campaign">
