export const LifeDeclined = () => (
    <svg id="Life_Policy_Declined" data-name="Life Policy Declined" xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24">
        ...
        <path id="Path_21946" data-name="Path 21946" d="M13.92-2.407-1.661,9.5" transform="translate(7.5 6.5)" fill="none" stroke="#4178ff" stroke-linecap="round" stroke-width="1" />
    </svg>
)