export const LeadCenter = () => {
    return (
        <svg id="Source_-_LeadCENTER" data-name="Source - LeadCENTER" xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24">
            ...
            <text id="LC" transform="translate(6 16)" fill="#4178ff" font-size="10" font-family="Lato-Bold, Lato" font-weight="700" letter-spacing="0.01em"><tspan x="0" y="0">LC</tspan></text>
        </svg>
    )
}