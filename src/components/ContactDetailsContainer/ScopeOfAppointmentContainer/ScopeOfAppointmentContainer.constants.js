export const SCOPES_OF_APPOINTMENT = "Scopes of Appointment";
...
export const SOA_FORM_DETAILS = "Scope of Appointment form needs to be completed and submitted for all scheduled appointments (even for no-shows, cancelled appointments, or those that do not result in a sale)";
...
export const MEDICARE_ADV_PLANS_EX1 = "Medicare Health Maintenance Organization (HMO) – Provides all the benefits of Original Medicare and sometimes includes Part D. In most HMOs, you can only get your care from doctors or hospitals in the plan’s network (except in emergencies).";
export const MEDICARE_ADV_PLANS_EX2 = "Medicare Preferred Provider Organization (PPO) Plan – Provides all the benefits of Original Medicare and sometimes covers Part D. PPOs have network doctors and hospitals but you can also use out-of-network providers, typically at a higher cost.";
...
export const MEDICARE_ADV_PLANS_EX4 = "Medicare Special Needs Plan (SNP) – A plan that has specific benefits intended for people with special health needs. Examples of special health needs include:";
export const MEDICARE_ADV_PLANS_EX4_POINT1 = "People who qualify for both Medicare and Medicaid"; export const MEDICARE_ADV_PLANS_EX4_POINT2 = "People in nursing homes";
...
export const MEDICARE_SUPPLEMENT_PRODUCTS_OVERVIEW1 = "Medigap is Medicare Supplement Insurance that helps fill “gaps” in Original Medicare and is sold by private companies. A Medicare Supplement Insurance (Medigap) policy can help pay some of the remaining health care costs, like:";
...
export const MEDICARE_SUPPLEMENT_PRODUCTS_OVERVIEW2 = "You must have Medicare Part A and Part B to get a Medicare Supplement plan. A Medigap plan is different from Medicare Part C because it only supplements your Original Medicare benefits. So, Medigap does not include Original Medicare or Part D coverage by itself.";
export const ANCILLARY_PRODUCTS = "Ancillary Products";
export const ANCILLARY_PRODUCTS_OVERVIEW = "You can get ancillary or secondary products through private insurance companies. These plans offer additional benefits to people who want separate coverage for things like dental, vision and hearing. Ancillary plans are not Medicare products.";