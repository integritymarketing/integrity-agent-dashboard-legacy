    ...
    <>
      {isModal && (
        <div className={styles.modalHeading}>
          Missing Active Selling Permissions?
        </div>
      )}
      <Box
      ...
      >
        ...
        <div className={styles.text}>
          Not all of your contracted carriers may appear in your Active Selling
          Permissions list.
        </div>
        <div className={styles.text}>
          This list will contain only those carriers which are available for
          enrollment in the platform, and that you have contracted through an
          Integrity Partner Agency. Carriers which are not contracted through an
          Integrity Partner, or available for enrollment, will not be displayed
          in your Active Selling Permissions list.
        </div>
        <div className={styles.text}>
