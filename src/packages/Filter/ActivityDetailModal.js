...
export default function ActivityDetailModal({open, handleClose, activityObj, onComplete, onSave}) {
    return (
        <div>
            <Modal
            ...
            >
                <Fade in={open}>
                    <Box sx={style}>
                        <Typography variant="h5" className={styles.headingSection}>{activityObj.name}</Typography>
