...
export const CampaignInvitationProvider = ({ children }) => {
    ...
    const AGENT_PURL_URL = `${import.meta.env.VITE_AGENTS_URL}/api/v1.0/Purl/npn/${npn}`;
    const AGENT_ACCOUNT_DETAILS_URL = `${import.meta.env.VITE_AGENTS_URL}/api/v1.0/AgentMobile/Available/${agentId}`;
    const CREATE_CAMPAIGN_URL = `${import.meta.env.VITE_COMMUNICATION_API}/CampaignLog/Create`;
    const UPDATE_CAMPAIGN_URL = `${import.meta.env.VITE_COMMUNICATION_API}/CampaignLog/Update`;
    const GET_CAMPAIGN_URL = `${import.meta.env.VITE_COMMUNICATION_API}/CampaignLog`;
                    ...
                    if (resData?.campaignChannel === "Email") {
                        ...
                        if (templateData) {
                            ...
                            if (
                                ...
                                if (resData?.campaignSelectedAction === "contacts filtered by…") {
    ...
    const updateCampaignRequestPayload = ({
        ...
        const payload = {
            ...
            requestPayload: {
                ...
                custom1: `${import.meta.env.VITE_MEDICARE_ENROLL}/quick-profile?purl=${agentPurlURL?.agentPurlCode}`,
                custom2: "Integrity",
                custom3: formattedPhoneNumber,
                custom4: `${import.meta.env.VITE_MEDICARE_ENROLL}/?purl=${agentPurlURL?.agentPurlCode}`,
