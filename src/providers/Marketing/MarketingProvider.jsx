...
export const MarketingProvider = ({ children }) => {
    ...
    const URL = `${import.meta.env.VITE_COMMUNICATION_API}/CampaignLog/GetCampaignLog/${npn}`;
    const COPY_CAMPAIGN_URL = `${import.meta.env.VITE_COMMUNICATION_API}/CampaignLog/Create`;
    const UPDATE_CAMPAIGN_URL = `${import.meta.env.VITE_COMMUNICATION_API}/CampaignLog/Update`;
    const DELETE_CAMPAIGN_URL = `${import.meta.env.VITE_COMMUNICATION_API}/CampaignLog`;
    const {
