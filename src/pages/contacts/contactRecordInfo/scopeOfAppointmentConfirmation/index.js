...
export default () => {
        ...
        return (
          <>
            ...
            <div className="soa-confirmation-form-page">
                ...
                <Card className="soa-confirmation-card">
                  <Form className="form mt-3">
                    ...
                    <section className="section-1">
                      ...
                      agents to document the scope of a marketing appointment
                      prior to any face-to-face sales meeting to ensure
                      understanding of what will be discussed between the agent
                      and the Medicare beneficiary (or their authorized
                    ...
                    <section className="section-3">
                      <span className="signing-form-1">
                        By signing this form, you agree to a meeting with a
                        sales agent to discuss the types of products you
                        indicated above. Please note, the person who will
                        discuss the products is either employed or contracted by
                        a Medicare plan. They do not work directly for the
                        federal government. This individual may also be paid
                        based on your enrollment in a plan.
                      </span>
                      <br />
                      <br />
                      <span className="signing-form-2">
                        Signing this form does NOT obligate you to enroll in a
                        plan, affect your current enrollment, or enroll you in a
                        Medicare plan.
                      </span>
                    </section>
                    <section className="beneficiary-details">
                      ...
                      <div className="person-enrolled">
                        ...
                        <span>
                          Each person enrolled in Medicare receives a Medicare
                          Beneficiary Identifier number (MBI) on their Medicare
                          card.{" "}
                          <strong>
                            Enter the information of the primary Medicare
                            beneficiary
                          </strong>{" "}
                          (cardholder).
                        </span>
                      ...
                      {values.hasAuthorizedRepresentative && (
                        ...
                        >
                          ...
                          <fieldset className="form__fields form__fields--constrained hide-input-err">
                            ...
                            {values?.authorizedRepresentative?.lastName.length >
                              50 && (
                              <div className="custom-error-msg">
                                Last name must be 50 characters or less
                              </div>
                          ...
                          <fieldset className="form__fields form__fields--constrained hide-input-err">
                            ...
                            />
                            {(touched.authorizedRepresentative?.phone ||
                              submitCount > 0) &&
                              errors?.authorizedRepresentative?.phone && (
                                <ul className="details-edit-custom-error-msg">
                                  <li className="error-msg-red ">
                          ...
                          <div className="authorized-representative-details">
                            ...
                            <div className="understand-contents-of-soa">
                              ...
                              <div className="understand-contents-of-soa-content">
                                By checking this box, I have read and understand
                                the contents of the Scope of Appointment form,
                                and that I confirm that the information I have
                                provided is accurate. If submitted by an
                                authorized individual (as described above), this
                                submission certifies that 1) this person is
                                authorized under State law to complete the Scope
                                of Appointment form, and 2) documentation of
                                this authority is available upon request by
                                Medicare.
                              </div>
                            </div>
                          </div>
              ...
              <section
                ref={medicareOverviewSectionEl}
                className="medicare-overview"
              >
  ...
  return (
    <WithLoader isLoading={isLoading}>
      <Navigation />
      {soaStatus?.status === "Completed" ||
      soaStatus?.status === "Need Agent Signature" ? (
