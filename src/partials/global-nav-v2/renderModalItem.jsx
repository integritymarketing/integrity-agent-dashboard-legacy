...
const RenderModalItem = ({
    ...
    const { data = false, call = false, leadCenter = false, medicareEnrollPurl = false } = preferences;
    const BUTTONS = {
        cancel: {
            text: "Cancel",
            onClick: () => {
                ...
                return (
                    <>
                        ...
                        >
                            ...
                            {call && <img src={Check} alt="activeIcon" className="active_icon" />}
                        </div>
                        ...
                        >
                            ...
                            {data && <img src={Check} alt="activeIcon" className="active_icon" />}
                        </div>

                        <div className="modalItemStyle">
                            <FooterButtons buttonOne={BUTTONS.cancel} buttonTwo={BUTTONS.checkIn} />
                        </div>
                    </>
                );
            case "leadSource":
                    ...
                    <>
                            ...
                            <div className="modal-lead-source">
                                ...
                                <div className="span_setup">
                                    <Button
                                        ...
                                        onClick={() =>
                                            window.open(
                                                `${import.meta.env.VITE_AUTH0_LEADS_REDIRECT_URI}/LeadCenterSSO`,
                                                "_blank"
                                            )
                                        }
                                    >
                        ...
                        >
                            <div className="modal-lead-source">
                                ...
                                {medicareEnrollPurl && <img src={Check} alt="activeIcon" className="active_icon" />}
                            </div>
                        </div>
            ...
            case "main":
                return (
                    <>
                        ...
                        >
                            <img className="modalItemImgStyle" alt="itemIcon" src={LeadSource} />
                            <div className="modalItemTextStyle">
                                <span className="span_title">Lead Source:</span>
                                <span className="span_source_type">
                                    {((leadCenter && medicareEnrollPurl) || (!leadCenter && !medicareEnrollPurl)) &&
                                        "LC/ME-pURL"}
