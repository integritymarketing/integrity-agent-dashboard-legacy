...
export default function Feature3() {
  return (
    <div className={Styles.featureContainer}>
      <img
        src="/images/landingPage/screens.png"
        alt=""
      ...
      <div className={Styles.featureBox}>
        ...
        <div className={Styles.featureContent}>
          ...
          <p className={Styles.featureText}>
            Access MedicareAPP, MedicareLINK, CSG APP and Integrity’s our CRM
            and Quoting and E-App system – Contact Management - with one
      ...
      <div className={Styles.featureBox}>
        ...
        <div className={Styles.featureImgContainer}>
          <img
            src="/images/landingPage/Interface.svg"
            alt=""
            className={Styles.featureImg}
          />
        </div>
        ...
        <div className={Styles.featureContent}>
          ...
          <p className={Styles.featureText}>
            Master comprehensive functions without a long learning curve. Take
            advantage of exclusive tips, guides, training, and resources in our
            LearningCENTER.
          </p>
        </div>
      </div>
      ...
      <div className={Styles.featureBox}>
        ...
        <div className={Styles.featureImgContainer}>
          <img
            src="/images/landingPage/insights.svg"
            alt=""
            className={Styles.featureImg}
          />
        </div>
