...
export default function Feature1() {
  return (
    <div className={Styles.featureContainer}>
      <img
        src="/images/landingPage/Mask Group 5.png"
        alt=""
      ...
      <div className={Styles.featureBox}>
        ...
        <div className={Styles.featureImgContainer}>
          <img
            src="/images/landingPage/Call-Recording.svg"
            alt=""
        ...
        <div className={Styles.featureContent}>
          ...
          <p className={Styles.featureText}>
            Simplify how you maintain compliance – this crucial feature allows
            you to record, download and store both inbound and outbound sales
            calls as required by CMS regulations.
          </p>
        </div>
      </div>
      {/* Feature Box*/}
      <div className={Styles.featureBox}>
        ...
        <div className={Styles.featureImgContainer}>
          <img
            src="/images/landingPage/Reporting.svg"
            alt=""
            className={Styles.featureImg}
          />
        </div>
      ...
      <div className={Styles.featureBox}>
        ...
        <div className={Styles.featureImgContainer}>
          <img
            src="/images/landingPage/Group 3412.svg"
            alt=""
            className={Styles.featureImg}
          />
        </div>
        ...
        <div className={Styles.featureContent}>
          ...
          <p className={Styles.featureText}>
            Work when you want, from where you want. Get mobile-exclusive push
            notifications, plus all the features of Integrity Clients. Download
            today!
          </p>
          <div className={Styles.getButtons}>
            <a href={GOOGLE_PLAY} target="_blank" rel="noopener noreferrer">
              <img
                src="/images/landingPage/badge-Google.svg"
                alt=""
                width="120px"
                height="40px"
              />
            ...
            <a href={APP_STORE} target="_blank" rel="noopener noreferrer">
              <img
                src="/images/landingPage/badge-Apple.svg"
                alt=""
                width="120px"
                height="40px"
              />
