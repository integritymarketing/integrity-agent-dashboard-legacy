...
const TaskListResultsMobileLayout = lazy(() =>
  import('pages/dashbaord/Tasklist/TaskListResultsMobileLayout')
);
const PolicySnapshotMobileLayout = lazy(() =>
  import(
    'pages/dashbaord/PolicySnapShot/PolicySnapShotMobileContainer/PolicySnapShotMobileContainer'
  )
);

const FinalExpensePlansPage = lazy(() => import('pages/FinalExpensePlansPage'));
const SimplifiedIULPlansPage = lazy(() =>
  import('pages/SimplifiedIULPlansPage')
);
const FinalExpenseCreateQuotePage = lazy(() =>
  import('pages/FinalExpenseCreateQuotePage')
);
const SimplifiedIULCreateQuotePage = lazy(() =>
  import('pages/SimplifiedIULCreateQuotePage')
);
const HealthConditionsPage = lazy(() => import('pages/HealthConditionsPage'));
const SimplifiedIULHealthConditionsPage = lazy(() =>
  import('pages/SimplifiedIULHealthConditionsPage')
);
...
const CampaignInvitationPage = lazy(() =>
  import('pages/Marketing/CampaignInvitation')
);
const CampaignDashboardPage = lazy(() =>
  import('pages/Marketing/CampaignDashboard')
);
const ClientConnectMarketingContainer = lazy(() =>
  import('pages/Marketing/ClientConnectMarketing')
);

const IulAccumulationConfirmationDetailsPage = lazy(() =>
  import('pages/IulAccumulationConfirmationDetailsPage')
);
const IulAccumulationProductPreferencesPage = lazy(() =>
  import('pages/IulAccumulationProductPreferencesPage')
);
const IulProtectionConfirmationDetailsPage = lazy(() =>
  import('pages/IulProtectionConfirmationDetailsPage')
);
...
const IulProtectionQuotePage = lazy(() =>
  import('pages/IulProtectionQuotePage')
);
const IulProtectionComparePlansPage = lazy(() =>
  import('pages/IulProtectionComparePlansPage')
);
const IulAccumulationQuoteDetailsPage = lazy(() =>
  import('pages/IulAccumulationQuoteDetailsPage')
);
const IulProtectionQuoteDetailsPage = lazy(() =>
  import('pages/IulProtectionQuoteDetailsPage')
);
const IulAccumulationComparePlansPage = lazy(() =>
  import('pages/IulAccumulationComparePlansPage')
);
